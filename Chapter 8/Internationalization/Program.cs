...
namespace Internationalization
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            WriteLine("The current globalization culture is {0}: {1}", arg0: globalization.Name, arg1: globalization.DisplayName);
            WriteLine("The current localization culture is {0}: {1}", arg0: localization.Name, arg1: localization.DisplayName);
